...
from modelFiles.model import ActorCritic, small_size, mid_size, large_size
from modelFiles.memory import *
import copy
...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip,
                 has_continuous_action_space, action_std_init=0.6, netsize=mid_size):
